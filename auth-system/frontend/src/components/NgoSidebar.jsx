...
const NgoSidebar = ({ activeTab, setActiveTab }) => {
  const tabs = [
    { id: 'food-requests', label: 'Available Food', icon: HandHeart }
  ];

  return (
    <aside className="clay-card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', position: 'sticky', top: '7rem' }}>
      <h3 style={{ marginBottom: '1.5rem', fontSize: '1.1rem', letterSpacing: '0.5px', color: 'var(--text-secondary)' }}>NGO Menu</h3>
